...
export default function MixedSLargeDetailsPage() {
  return (
    <div className="min-h-screen bg-merino">
      ...
      <section className="py-16 bg-parchment">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl font-bold text-old-copper mb-4">Mixed S — Large Tiles</h1>
              <p className="text-xl text-old-copper/70 mb-6">
                Classic S-curve with broader wave for traditional Mediterranean homes.
              </p>
              <div className="flex gap-4">
                <Link href="/colors/mixed-s-large">
            ...
            <div className="relative h-96 rounded-2xl overflow-hidden shadow-xl">
              <Image src="/tiles/red-roof-tile.jpg" alt="Mixed S Large tile close-up" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-old-copper/70">470 × 286 × 75 mm (18.5″ × 11.3″ × 2.9″)</p>
              </div>
              <div>
                <h3 className="font-semibold text-old-copper mb-2">Weight</h3>
                <p className="text-old-copper/70">3.85 kg (8.5 lb) per tile</p>
              </div>
              <div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-old-copper mb-8">Nerdy Facts About Mixed S — Large</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl shadow-md p-6">
              <h3 className="font-bold text-old-copper mb-3">🌊 Wave Profile</h3>
              <p className="text-old-copper/70">The broader S-curve creates dramatic shadow lines on roofs.</p>
            </div>
            <div className="bg-white rounded-xl shadow-md p-6">
              <h3 className="font-bold text-old-copper mb-3">🏛️ Historical Roots</h3>
              <p className="text-old-copper/70">Design inspired by centuries-old Mediterranean roofing traditions.</p>
            </div>
            <div className="bg-white rounded-xl shadow-md p-6">
              <h3 className="font-bold text-old-copper mb-3">💧 Water Management</h3>
              <p className="text-old-copper/70">Double interlocking system provides superior water channeling.</p>
            </div>
          </div>
        </div>
      </section>
