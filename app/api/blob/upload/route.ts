  ...
  try {
    ...
    const result = await handleUpload({
      ...
      onBeforeGenerateToken: async (pathname, clientPayload) => {
        ...
        return {
          allowedContentTypes: [
            "image/jpeg", "image/png", "image/webp", "image/gif", // For photos
            "application/pdf", "application/msword", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", // For docs
            "text/plain" // Optional plain text
          ], // Limit to your expected types (add more as needed)
