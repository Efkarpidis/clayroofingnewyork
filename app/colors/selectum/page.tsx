...
export default function SelectumColorsPage() {
  return (
    <div className="min-h-screen bg-merino">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-old-copper mb-4">Selectum Color Options</h1>
          <p className="text-xl text-old-copper/70 mb-12">
            Explore our premium Selectum tile colors. Available in Matte, Gloss, and Design finishes.
          </p>
