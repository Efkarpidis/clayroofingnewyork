...
// Placeholder S-Mixed tiles - will auto-generate when assets are uploaded
const mixedTiles: TileColor[] = [
  {
    id: "mediterranean-blend",
    name: "Mediterranean Blend",
    image: "/tiles/mixed/mixed-mediterranean-placeholder.png",
    filename: "MIXED MEDITERRANEAN BLEND TILE.png",
  },
  {
    id: "tuscan-mix",
    name: "Tuscan Mix",
    image: "/tiles/mixed/mixed-tuscan-placeholder.png",
    filename: "MIXED TUSCAN MIX TILE.png",
  },
  {
    id: "antique-blend",
    name: "Antique Blend",
    image: "/tiles/mixed/mixed-antique-placeholder.png",
    filename: "MIXED ANTIQUE BLEND TILE.png",
  },
]
        ...
        <section className="pt-20 pb-16 bg-gradient-to-b from-neutral-50 to-white mt-10 sm:mt-12 md:mt-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto leading-relaxed">
              Traditional S-shaped tiles with varied color blending, creating authentic Mediterranean character.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-neutral-50 border-t border-neutral-200">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact#form?tileFamily=S-Mixed" className="relative z-20">
          ...
          {selectedTile && (
            <div>
              <DialogHeader className="mb-6">
                <DialogTitle className="text-2xl font-bold text-center">S-Mixed {selectedTile.name}</DialogTitle>
              </DialogHeader>
              ...
              <div className="bg-neutral-50 rounded-lg p-8 mb-6">
                <div className="aspect-square relative max-w-sm mx-auto">
                  <Image
                    ...
                    alt={`S-Mixed ${selectedTile.name} tile`}
                    fill
